...
## Code map
- `app-shell`: `main.js`, `app.js`, `match.js`, `client_perf_report.js`, `frame_profiler.js`,
  ...
  injection, frame-loop health, observer analysis, and replay/spectator/lab shell wiring.
...
- `ui`: HUD, command card descriptors/selection panels, hotkey profiles/editor, lobby
  controller/view, match history, resource icons, scoreboard, status badge, minimap, branch
