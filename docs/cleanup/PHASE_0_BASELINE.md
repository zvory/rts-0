...
The baseline was measured after syncing `main` to commit `22b436e`, before landing this docs-only
baseline merge.
...
| File | Lines |
| --- | ---: |
| `server/src/game/ai_core/decision.rs` | 4,877 |
| `server/src/game/selfplay.rs` | 3,462 |
...
| `server/src/game/entity.rs` | 1,620 |
| `server/src/lobby.rs` | 1,627 |
| `server/src/game/services/move_coordinator.rs` | 1,444 |

Total hotspot lines: 22,142.
