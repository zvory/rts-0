...
source Command Car, spawns the plane there, flies it to the clicked point, starts the 20-second orbit
timer only after arrival, and despawns it when the timer expires. Scout Plane sorties have no City
