...
- Terrain: muted grass/field, three gravel surfaces, three dirt surfaces, three mud surfaces,
  ...
  Checked-in Lab visual profiles may replace the chip mask with dithered or organic-contour prototype
  masks and suppress the fog presentation over a dedicated authoritative terrain matrix for
