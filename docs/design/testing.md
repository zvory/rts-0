...
- `replay_303_scout_car_forest_lock` — replay 303 reduced to Soupman's seven ordered vehicles and
  ...
  and issues the six recorded group moves from ticks 15,283 through 15,308. The reproduction drives
  Scout Car 403 through its former lock at `(2148.72, 3983.10)` and verifies that it keeps moving.
