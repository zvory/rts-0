...
two-tile-overlap triangular lattice. At most 24 Riflemen are committed to the primary wall, with
only Riflemen beyond the six-per-line
...
Once at least six surplus Riflemen exist, up to sixteen form two forward screening ranks five tiles
ahead of Jeff's compact Tank cohort. The Rifle screen takes contact and attacks revealed anti-tank
guns while the Tanks hold outside the gun envelope or back out of it before resuming the push.
