...
- Oil extraction: workers do not directly mine oil. The worker build card exposes Pump Jack in its
  ...
  preview to the nearest visible live oil patch. A worker right-click on a live oil patch continues
  to issue the same Pump Jack build directly. Completed Pump Jacks mine
