...
| `cultivators` | playable | Economy-first catalog: Nexus (shared ResourceDepot), Portal, Engineer, Warrior, Steel Mine and Oil Pumpjack. Portal is a dedicated 3x3 building that produces Warriors. Standard economy loadout without Riflemen; human beta/local selector enabled, normal playable lifecycle policy applies. No new AI profile; prediction remains unsupported. |
...
Runtime identity is still global `EntityKind`. The current roster has 29 global kinds: 15 units,
...
- Units: Worker, Golem, Warrior, Rifleman, Panzerfaust, Machine Gunner, Anti-Tank Gun, Mortar Team,
  Artillery, Rocket Truck, Scout Car, Scout Plane, Tank, Command Car, and Ekat.
...
player gets one completed Resource Depot, one Engineer and four Riflemen in separate rings, nearby
Steel/Oil resource clusters, and starting Steel and Oil. Unknown non-empty faction ids receive no
...
The `cultivators.standard` loadout reuses Kriegsia starting resources and economy entities, without Riflemen.
