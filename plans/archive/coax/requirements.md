...
- For this implementation, infantry-priority targets are Workers, Riflemen, and Machine Gunners.
  Future infantry units should opt in through their own requirements or balance pass.
