...
- Add bounded `lab-interact record-start` and `lab-interact record-stop` commands requiring the
...
- Lab Interact daemon/driver recorder and CLI schemas
- shared clean presentation and renderer readiness from Phase 3
- ignored `target/lab-interact/` artifact structure and manifest helpers
...
- Lab Interact skill and documentation for start, manipulate, stop, inspect, and share
...
- Keep every media artifact under `target/lab-interact/`.
