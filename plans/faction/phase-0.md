...
- Add architecture-check coverage or a script/report that can flag new direct special cases outside
  approved modules.
- Document the approved places for compatibility special cases while the migration is in progress.
...
assumptions that Phase 1 must avoid breaking. It should also name any special cases that were found
