...
Status: Updated through Phase 11 Ekaterina combat/signature ability slice. Every later phase that touches a match
...
- First real second faction: `ekaterina` (**Ekaterina**), playable only through the Phase 10/11
