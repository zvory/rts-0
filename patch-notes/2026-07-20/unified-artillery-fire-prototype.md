...
- Queued artillery fire retains its selected target center and radius in the server-owned order.
  The queue preview shows the locked center but does not display the selected radius.
