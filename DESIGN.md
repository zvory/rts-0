...
| Vocabulary | Codes |
|------------|-------|
| `kind` | 1 `worker`, 2 `rifleman`, 3 `machine_gunner`, 4 `at_team`, 5 `tank`, 6 `city_centre`, 7 `depot`, 8 `barracks`, 9 `training_centre`, 10 `factory`, 11 `steel`, 12 `oil`, 13 `steelworks` |
...
```
{
  ...
  kind: string,                  // EntityKind: "worker","rifleman","machine_gunner","at_team","tank","city_centre","depot","barracks","training_centre","factory","steelworks"
