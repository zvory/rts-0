...
export const STATS = Object.freeze({
  ...
  [KIND.PANZERFAUST]: { label: "Panzerfaust", icon: "PF", size: 9, sight: 8,
    ...
    description: "Infantry with a one-shot anti-tank weapon. Fires once at Tanks or Scout Cars for 100 damage with 50% armor penetration, then becomes a Rifleman. Moves at Rifleman speed; Methamphetamines shortens windup and recovery and boosts movement." },
