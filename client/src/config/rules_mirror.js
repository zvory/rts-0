...
export const ENTRENCHMENT_RESEARCH_TICKS = TICK_HZ * 20;
...
export const STATS = Object.freeze({
  ...
  [KIND.WARRIOR]: { label: "Warrior", icon: "WR", size: 13.5, sight: 11,
    rangeTiles: 0.5, cost: { steel: 100, oil: 0 }, supply: 2, buildTicks: 300,
    description: "Durable melee infantry with a short sword reach and 50% armor penetration. Slow attacks deal heavy damage." },
  ...
  [KIND.RESOURCE_DEPOT]: { label: "Resource Depot", icon: "RD", footW: 3, footH: 3, sight: 1,
    cost: { steel: 450, oil: 100 }, buildTicks: TICK_HZ * 5,
    trains: [KIND.WORKER, KIND.STEEL_MINE, KIND.PUMP_JACK] },
  [KIND.PORTAL]: { label: "Portal", icon: "PRT", footW: 3, footH: 3, sight: 1,
    cost: { steel: 150, oil: 0 }, buildTicks: TICK_HZ * 5, trains: [KIND.WARRIOR],
    description: "A supernatural gateway that trains Cultivator Warriors." },
...
export const ABILITIES = Object.freeze({
  ...
  [ABILITY.SCOUT_PLANE]: Object.freeze({
    ...
    carriers: Object.freeze([KIND.RESOURCE_DEPOT, KIND.COMMAND_CAR]),
    targetMode: "worldPoint",
    rangeTiles: null,
    cooldownTicks: SCOUT_PLANE_ABILITY_COOLDOWN_TICKS,
    cost: Object.freeze({ steel: 50, oil: 75 }),
    carrierCosts: Object.freeze({
      [KIND.RESOURCE_DEPOT]: Object.freeze({ steel: 38, oil: 56 }),
      [KIND.COMMAND_CAR]: Object.freeze({ steel: 63, oil: 94 }),
    }),
...
export const UPGRADES = Object.freeze({
  ...
  [UPGRADE.PANZERFAUSTS]: Object.freeze({
    ...
    description: `Unlock Panzerfaust rifle infantry at the Barracks`,
    researchedAt: KIND.TRAINING_CENTRE,
  }),
