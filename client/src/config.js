...
export const STATS = Object.freeze({
  ...
  [KIND.MACHINE_GUNNER]: { label: "Machine Gunner", icon: "MG", size: 10, sight: 8,
    cost: { steel: 75, oil: 25 }, supply: 2, buildTicks: 200, requires: KIND.ADVANCED_TRAINING_CENTRE },
  [KIND.AT_TEAM]: { label: "AT Team", icon: "AT", size: 10, sight: 8,
    cost: { steel: 75, oil: 25 }, supply: 2, buildTicks: 220, requires: KIND.ADVANCED_TRAINING_CENTRE },
  ...
  [KIND.ADVANCED_TRAINING_CENTRE]: { label: "Advanced Training Centre", icon: "TC", footW: 3, footH: 2, sight: 6,
    cost: { steel: 125, oil: 0 }, buildTicks: 220, trains: [], requires: KIND.INDUSTRIAL_CENTER },
  [KIND.TANK_FACTORY]: { label: "Tank Factory", icon: "TF", footW: 3, footH: 3, sight: 6,
    cost: { steel: 150, oil: 0 }, buildTicks: 240, trains: [KIND.TANK], requires: KIND.INDUSTRIAL_CENTER },
  [KIND.BUNKER]: { label: "Bunker", icon: "BN", footW: 2, footH: 2, sight: 6,
    cost: { steel: 150, oil: 0 }, buildTicks: 120, trains: [], requires: KIND.INDUSTRIAL_CENTER },

  [KIND.STEEL]: { label: "Steel", size: 11 },
