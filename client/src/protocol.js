...
export const cmd = Object.freeze({
  ...
  formationMove: (units, points, queued = false, attackMove = false) =>
  ...
  blanketFire: (units, x, y, radiusTiles, queued = false) =>
    withQueued({ c: CMD.ARTILLERY_FIRE, units, x, y, radiusTiles }, queued),
