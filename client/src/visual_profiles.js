...
const VISUAL_PROFILE_ENTRIES = Object.freeze([
  ...
  Object.freeze({
    id: "terrain-blend-soft-ramp",
    label: "Terrain blend: soft ramp",
    description: "A 68% straight transition band whose source color fades into the destination texture.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "soft-ramp",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-soft-organic",
    label: "Terrain blend: soft organic",
    description: "A 68% organic contour with source color feathered into the destination texture.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "soft-organic",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
