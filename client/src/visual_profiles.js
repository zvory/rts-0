...
const VISUAL_PROFILE_ENTRIES = Object.freeze([
  ...
  Object.freeze({
    id: "terrain-blend-hard-chips",
    label: "Terrain blend: hard chips",
    description: "Generalized low-resolution material creep using irregular categorical edge chips.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "hard-chips",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-dither",
    label: "Terrain blend: dither",
    description: "Generalized low-resolution material creep using an ordered noisy transition band.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "dither",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-dither-bayer",
    label: "Terrain blend: Bayer dither",
    description: "A five-band 56% ordered Bayer fade using only crisp source-color pixels.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "dither-bayer",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-dither-stochastic",
    label: "Terrain blend: stochastic dither",
    description: "A five-band 56% irregular fade using deterministic opaque source-color pixels.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "dither-stochastic",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-dither-clustered",
    label: "Terrain blend: clustered dither",
    description: "A five-band 56% clustered-dot fade that keeps small pixel-art chips together.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "dither-clustered",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-hard-chips-wide",
    label: "Terrain blend: wide hard chips",
    description: "Depth-only comparison using a 68% solid-color categorical transition band.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "hard-chips-wide",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-organic",
    label: "Terrain blend: organic",
    description: "Generalized low-resolution material creep using continuous jagged contours and islands.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "organic",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
    id: "terrain-blend-organic-wide",
    label: "Terrain blend: wide organic",
    description: "Depth-only comparison using a 68% solid-color organic contour.",
    initialCamera: cameraSnapshot(2016, 2016, 0.58),
    terrainBlendMode: "organic-wide",
    terrainPreviewReveal: true,
  }),
  Object.freeze({
