...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      '2026-06-24T03:30:00Z DEBUG event="pathing" room="beta pathing" match_run_id="pathing-1" tick=123 pass="awaiting_paths" awaiting_start=96 queued_for_path=0 requests_processed=64 requests_deferred=32 still_awaiting=32 path_success=60 path_failed=4 same_tile=0 cache_hits=8 cache_misses=56 path_budget_exhausted=1 coordinator_budget_exhausted=true total_request_ms=310 worst_request_ms=42 worst_request_bucket="34ms+" explored_nodes_max=9001 path_len_max=220 source_counts="move=64" group_size_buckets="none" path_len_buckets="129+=64" explored_node_buckets="8193+=1,2049-8192=63" cache_available=true complexity_available=true fuse_triggered=false "performance pathing diagnostics"',
      '2026-06-24T03:30:00Z DEBUG event="pathing" room="beta pathing" match_run_id="pathing-1" tick=123 pass="promote_queued_orders" awaiting_start=0 queued_for_path=40 requests_processed=0 requests_deferred=40 still_awaiting=40 path_success=0 path_failed=0 same_tile=0 cache_hits=0 cache_misses=0 path_budget_exhausted=0 coordinator_budget_exhausted=false total_request_ms=0 worst_request_ms=0 worst_request_bucket="0ms" explored_nodes_max=0 path_len_max=0 source_counts="attackMove=40" group_size_buckets="17-64=1" path_len_buckets="none" explored_node_buckets="none" cache_available=true complexity_available=true fuse_triggered=false "performance pathing diagnostics"',
    ].join("\n") + "\n"
  );
