...
// ---------------------------------------------------------------------------
{
  ...
  assert(KIND_CODE[KIND.EKATERINA] === 19, "Ekaterina compact kind code should be reserved");
  ...
  assert(ABILITY_CODE[ABILITY.EKATERINA_TELEPORT] === 6, "Ekaterina Teleport compact ability code should be reserved");
  assert(ABILITY_CODE[ABILITY.EKATERINA_LINE_SHOT] === 7, "Ekaterina Line Shot compact ability code should be reserved");
  ...
  assert(ORDER_STAGE_CODE[ORDER_STAGE.EKATERINA_TELEPORT] === 12, "Ekaterina Teleport compact order stage code should be reserved");
  assert(ORDER_STAGE_CODE[ORDER_STAGE.EKATERINA_LINE_SHOT] === 13, "Ekaterina Line Shot compact order stage code should be reserved");
