...
// ---------------------------------------------------------------------------
{
  ...
  assert(state.resourceById.get(201).remaining === 1666, "oil defaults to full known amount");
  ...
  assert(state.entityById(201).remaining === 1666, "untouched resources keep their last-known amount");
