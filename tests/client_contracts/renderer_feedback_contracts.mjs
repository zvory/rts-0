...

{
  ...
  performance.now = () => fixedNow;
  try {
    _drawMortarShells.call({ _feedbackGfx: barrageGfx }, {
      liveMortarShells: () => [rocket],
    });
...

{
  ...
  performance.now = () => fixedNow;
  try {
    _drawMortarImpacts.call({ _feedbackGfx: mortarGfx, _map: { tileSize: 32 } }, {
      liveMortarImpacts: () => [impact],
    });
    _drawMortarImpacts.call({ _feedbackGfx: rocketGfx, _map: { tileSize: 32 } }, {
