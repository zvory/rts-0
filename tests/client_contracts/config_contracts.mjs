...
// ---------------------------------------------------------------------------
{
  ...
  try {
    ...
    assert(
      mortarButton?.innerHTML.includes(
        "Indirect fire. Shots scatter heavily without team vision. Research Mortar Autocast in R&D.",
      ),
      "Mortar Team tooltip should explain indirect fire scatter and R&D autocast",
    );
