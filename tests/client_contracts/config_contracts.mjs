...
// ---------------------------------------------------------------------------
{
  ...
  assert(
    ...
    "Artillery training requires Field Ordnance",
  );
  assert(
  ...
  assertDeepEqual(
    ...
    "R&D Complex should expose Field Ordnance, Artillery Fire Control, Tank, Command Car, and Mortar Autocast research",
  );
  ...
  assert(
    ...
    "Artillery Fire Control research cost, time, label, and icon mirror server",
  );
  assert(
    UPGRADES[UPGRADE.BALLISTIC_TABLES].requiresUpgrade === UPGRADE.ANTI_TANK_GUN_UNLOCK &&
      UPGRADES[UPGRADE.BALLISTIC_TABLES].requiresText === "Requires Field Ordnance",
    "Artillery Fire Control research should mirror its Field Ordnance prerequisite",
  );
  assert(
  ...
  try {
    ...
    const fieldOrdnanceResearchButton = renderedButtons.find((button) => button.innerHTML.includes("ORD"));
    ...
    assert(!fieldOrdnanceResearchButton, "Field Ordnance research should stay out of Gun Works");
    ...
    const rdFieldOrdnanceResearchButton = renderedButtons.find((button) => button.innerHTML.includes("ORD"));
    ...
    assert(rdFieldOrdnanceResearchButton?.dataset.hotkey === "Q", "Field Ordnance research should appear in R&D Complex");
    ...
    assert(rdArtilleryFireControlButton?.disabled, "Artillery Fire Control research should be disabled before Field Ordnance");
    assert(rdArtilleryFireControlButton?.title === "Requires Field Ordnance", "Artillery Fire Control research should name Field Ordnance prerequisite");
    ...
    assert(unlockedArtilleryFireControlButton && !unlockedArtilleryFireControlButton.disabled, "Artillery Fire Control should enable after Field Ordnance");
