...
const assembler = new PresentationFrameAssembler({
  map: {
    ...
    doodads: [
      ...
      { id: 5, typeId: "tree.spruce.topdown", x: 80, y: 72 },
    ],
  },
});
...
assert.equal(packet.message.payload.map.doodads.length, 3, "map-generation carries side-view/top-down doodads once with static terrain");
