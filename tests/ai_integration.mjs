...
(async () => {
  ...
  // The match is live: confirm the human keeps receiving snapshots and its HQ is present. (The
  ...
  ok(firstSnap.entities.some((e) => e.owner === A.playerId && e.kind === "hq"), "human owns its HQ in-match");
