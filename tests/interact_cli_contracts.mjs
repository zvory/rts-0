...
try {
  ...
  assert.ok(
    INTERACT_COMMAND_HELP.open.defaults.includes("map=Classic"),
    "Lab open help advertises the current default Classic map",
  );
  ...
  assert.equal(coldOpen.result.status.map, "Classic", "a blank Lab open uses the current default Classic map");
