...
export function interactArtifactRoot(mode: "lab" | "game" | "scenario" | "map-editor") {
  return path.join("target", "interact", mode);
}

export function createInteractSessionDirectory(workspaceRoot: string, map: unknown, mode: "lab" | "game" | "scenario" | "map-editor") {
