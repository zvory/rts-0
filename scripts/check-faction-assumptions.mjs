...
const approvedSpecialCaseBudgets = new Map([
  ...
  // Cultivators intentionally reuses the existing depot/worker kinds in catalog rows and tests.
  ["server/crates/rules/src/faction.rs", 138],
