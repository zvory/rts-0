...
const EXPECTED_CLIENT_CONFIG_CONSTANT_KEYS = Object.freeze([
  ...
  "artilleryFireControlMinFireRadiusTiles",
...
const EXPECTED_ABILITY_EFFECT_FIELDS_BY_ID = Object.freeze({
  ...
  [ABILITY.BARRAGE]: Object.freeze(["radiusTiles"]),
});
...
const clientConstants = {
  ...
  artilleryMinFireRadiusTiles: ARTILLERY_MIN_FIRE_RADIUS_TILES,
  artilleryFireControlMinFireRadiusTiles: ARTILLERY_FIRE_CONTROL_MIN_FIRE_RADIUS_TILES,
...
const clientBodies = {
  ...
  [KIND.ROCKET_LAUNCHER]: ROCKET_LAUNCHER_BODY,
};
assertSortedObjectKeys(
...
const clientUpgradeResearchTicks = {
  ...
  [UPGRADE.ROCKETS]: ROCKETS_RESEARCH_TICKS,
};
assertSortedObjectKeys(
