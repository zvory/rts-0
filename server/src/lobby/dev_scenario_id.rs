...
pub(in crate::lobby) enum DevScenarioId {
    ...
    DirectReverseOrder,
    ScoutCarOpenGroundLPath,
    ScoutCarLakeReverseLPath,
...
impl DevScenarioId {
    pub(in crate::lobby) fn from_room_id(id: &str) -> Option<Self> {
        match id {
            ...
            "scout_car_open_ground_l_path" => Some(Self::ScoutCarOpenGroundLPath),
            "scout_car_lake_reverse_l_path" => Some(Self::ScoutCarLakeReverseLPath),
            ...
            "replay_384_tank_forest_lock" => Some(Self::Replay384TankForestLock),
            ...
            "move_reload_acquisition" => Some(Self::MoveReloadAcquisition),
    ...
    pub(in crate::lobby) fn room_id(&self) -> &'static str {
        match self {
            ...
            Self::ScoutCarOpenGroundLPath => "scout_car_open_ground_l_path",
            Self::ScoutCarLakeReverseLPath => "scout_car_lake_reverse_l_path",
            ...
            Self::Replay384TankForestLock => "replay_384_tank_forest_lock",
            ...
            Self::MoveReloadAcquisition => "move_reload_acquisition",
