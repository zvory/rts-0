...
impl RoomTask {
    ...
    fn match_duration_ms_for(&self, ended_at: chrono::DateTime<chrono::Utc>) -> Option<i64> {
    ...
    fn will_record_match_history(&self) -> bool {
    ...
    pub(super) fn build_match_history_record(
        ...
        duration_ms: i32,
        scores: &[PlayerScore],
        replay_artifact: Option<&ReplayArtifactV1>,
        outcome: crate::db::MatchOutcome,
        ...
        let replay = if self.should_attach_match_history_replay_artifact() {
            replay_artifact.and_then(|artifact| {
    ...
    fn queue_match_history_write(&self, rec: crate::db::MatchRecord) -> bool {
    ...
    pub(super) fn end_match(
        ...
        {
            let rec = self.build_match_history_record(
                started_at,
                ended_at,
                duration_ms as i32,
                &scores,
