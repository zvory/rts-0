...
pub(super) const TANK_REVERSE_TRAFFIC_SPEC: DevScenarioSpec = DevScenarioSpec {
    ...
    description: "Three reinforced Tanks form a shallow fan with adjacent headings 10 degrees apart, take frontal fire from three deployed Anti-Tank Guns, then after 10 seconds receive simultaneous converging moves behind them. Future under-fire reverse paths require rearward traffic control.",
