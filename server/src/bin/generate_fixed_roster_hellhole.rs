...
use rts_server::tools::hellhole_spec::{
    fixed_roster_composition, respawn_candidates, CENTER, SCATTERED_TANK_TRAP_COUNT, SEED,
...
const OUT: &str = concat!(
    ...
    "/assets/lab-scenarios/fixed-roster-hellhole.json"
);
const MAP_NAME: &str = "Chokes";
const SCENARIO_NAME: &str = "Fixed Roster 2v2 Hellhole";
