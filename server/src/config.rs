...
pub fn unit_stats(kind: &str) -> Option<UnitStats> {
    let s = match kind {
        kinds::WORKER => UnitStats {
            hp: 40, dmg: 4, range_tiles: 1, cooldown: 12, speed: 3.0, sight_tiles: 7,
            cost_min: 50, cost_gas: 0, supply: 1, build_ticks: 120, radius: 9.0,
        },
        kinds::SOLDIER => UnitStats {
            hp: 45, dmg: 6, range_tiles: 4, cooldown: 8, speed: 3.2, sight_tiles: 8,
            cost_min: 50, cost_gas: 0, supply: 1, build_ticks: 150, radius: 9.0,
        },
        kinds::HEAVY => UnitStats {
            hp: 130, dmg: 20, range_tiles: 3, cooldown: 18, speed: 2.0, sight_tiles: 7,
            cost_min: 100, cost_gas: 50, supply: 2, build_ticks: 250, radius: 13.0,
        },
        _ => return None,
    };
    Some(s)
...
pub fn building_stats(kind: &str) -> Option<BuildingStats> {
    let s = match kind {
        kinds::HQ => BuildingStats {
            hp: 600, sight_tiles: 9, cost_min: 400, cost_gas: 0, foot_w: 3, foot_h: 3,
            build_ticks: 400, provides_supply: HQ_SUPPLY, dmg: 0, range_tiles: 0, cooldown: 0,
        },
        kinds::DEPOT => BuildingStats {
            hp: 220, sight_tiles: 4, cost_min: 50, cost_gas: 0, foot_w: 2, foot_h: 2,
            build_ticks: 120, provides_supply: DEPOT_SUPPLY, dmg: 0, range_tiles: 0, cooldown: 0,
        },
        kinds::BARRACKS => BuildingStats {
            hp: 320, sight_tiles: 6, cost_min: 100, cost_gas: 0, foot_w: 3, foot_h: 2,
            build_ticks: 200, provides_supply: 0, dmg: 0, range_tiles: 0, cooldown: 0,
        },
        kinds::TURRET => BuildingStats {
            hp: 200, sight_tiles: 6, cost_min: 75, cost_gas: 0, foot_w: 1, foot_h: 1,
            build_ticks: 120, provides_supply: 0, dmg: 10, range_tiles: 7, cooldown: 10,
        },
        _ => return None,
    };
    Some(s)
