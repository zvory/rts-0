...
use super::profiles::{
    profile_by_id, AiProfile, AI_2_1_ID, AI_TURTLE_ID, JEFFS_AI_ID, JEFFS_AI_PRE_RIFLE_COVERAGE_ID,
};
...
fn baseline_metadata(profile_id: &str) -> (&'static str, &'static str, Vec<&'static str>) {
    match profile_id {
        ...
        JEFFS_AI_ID | JEFFS_AI_PRE_RIFLE_COVERAGE_ID => (
            "Jeff's AI",
...
mod tests {
    ...
    fn jeff_profile_fingerprint_uses_stable_canonical_data() {
        ...
        assert_eq!(identity.fingerprint, "fnv1a64:d6ad9b22bdc9f9c0");
    }
}
