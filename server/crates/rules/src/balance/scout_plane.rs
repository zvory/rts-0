...
pub const SCOUT_PLANE_RESOURCE_DEPOT_COST_STEEL: u32 = 38;
pub const SCOUT_PLANE_RESOURCE_DEPOT_COST_OIL: u32 = 56;
pub const SCOUT_PLANE_COMMAND_CAR_COST_STEEL: u32 = 63;
pub const SCOUT_PLANE_COMMAND_CAR_COST_OIL: u32 = 94;
pub const SCOUT_PLANE_SUPPLY: u32 = 0;
pub const SCOUT_PLANE_ORBIT_RADIUS_TILES: u32 = 2;
pub const SCOUT_PLANE_LIFETIME_TICKS: u16 = (TICK_HZ * 30) as u16;
