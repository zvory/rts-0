...
pub const MORTAR_RANGE_TILES: u32 = 20;
...
pub const PANZERFAUST_RANGE_TILES: u32 = 3;
pub const PANZERFAUST_DAMAGE: u32 = 60;
pub const PANZERFAUST_WINDUP_TICKS: u16 = (TICK_HZ as u16) / 2;
pub const PANZERFAUST_TRAVEL_TICKS: u32 = TICK_HZ / 2;
pub const PANZERFAUST_RECOVERY_TICKS: u16 = (TICK_HZ as u16) / 2;
pub const METHAMPHETAMINES_PANZERFAUST_WINDUP_TICKS: u16 =
    (PANZERFAUST_WINDUP_TICKS * 3 + 3) / 4;
pub const METHAMPHETAMINES_PANZERFAUST_RECOVERY_TICKS: u16 =
    (PANZERFAUST_RECOVERY_TICKS * 3 + 3) / 4;
