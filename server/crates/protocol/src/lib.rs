...
use contract_metadata::{
    ...
    order_stage_code, setup_state_code, state_code, upgrade_code,
};
...
pub use contract_metadata::{
    ...
    ProtocolVocabularies, SNAPSHOT_CODEC_COMPACT_JSON, SNAPSHOT_CODEC_MESSAGEPACK_COMPACT,
    SNAPSHOT_CODEC_VERSION, SNAPSHOT_FRAME_KIND_BINARY, SNAPSHOT_FRAME_KIND_TEXT,
    SlotField, SnapshotCodecContract,
};
