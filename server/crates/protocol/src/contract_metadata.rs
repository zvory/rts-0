...
pub mod terrain {
    ...
    pub const ROAD_BARE: u8 = 3; // passable, 1.5x movement speed
    pub const ROAD_HORIZONTAL: u8 = 4; // passable, 1.5x movement speed
    pub const ROAD_VERTICAL: u8 = 5; // passable, 1.5x movement speed
    pub const ROAD_DIAGONAL_NW_SE: u8 = 6; // passable, 1.5x movement speed
    pub const ROAD_DIAGONAL_NE_SW: u8 = 7; // passable, 1.5x movement speed
}
