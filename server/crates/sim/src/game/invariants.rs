...
mod tests {
    ...
    /// Steel patch placement must stay within Resource Depot distance bounds for any STEEL_PATCHES_PER_BASE.
    /// Regression: doubling patches to 24 caused rows 2/3 to exceed START_RESOURCE_MAX_DIST_TILES.
    #[test]
