...
fn fixture_faction_start_uses_catalog_loadout_and_shared_resources() {
    ...
    assert_eq!(fixture.supply_cap, config::PLAYER_SUPPLY_CAP);
    assert_eq!(
        fixture.supply_used,
...
fn unknown_faction_start_and_commands_fail_closed() {
    ...
    assert_eq!(
        ...
        (0, 0, 0, config::PLAYER_SUPPLY_CAP)
    );
    ...
    assert_eq!(resources_before, (0, 0, 0, config::PLAYER_SUPPLY_CAP));
...
fn standard_starting_loadout_matches_phase0_inventory() {
    ...
    for player in &game.state.players {
        ...
        assert_eq!(player.supply_cap, config::PLAYER_SUPPLY_CAP);
